/**
 * LandingPage — árvore pública isolada.
 * Importada diretamente (sem lazy) pois é o entry-point principal.
 */
...
export default function LandingPage() {
  ...
  const goSignUp = () => { navigate('/cadastro'); window.scrollTo({ top: 0 }); };
  const goLogin  = () => { navigate('/login');    window.scrollTo({ top: 0 }); };
